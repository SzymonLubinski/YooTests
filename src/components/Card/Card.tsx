...
const Card:FC<CardProps> = ({itemId, name, images, price}) => {

    return (
        <li id={itemId} className={styles.product}>
            <Link className={styles.product__link} to={`/el/${itemId}`}>
                <div className={styles.product__images}>
                    <img src={images[0]} alt={''}/>
                </div>
                <div className={styles.textBox}>
                    {price} zł
                    <span className={styles.textBox__svgContainer}>
